...
class Statistics:
    ...
    ########################################################### Calculate federated learning results ###########################################################################################
    def federated_results():

        Statistics.fedResults = [Statistics.train_accuracy, Statistics.test_accuracy, Statistics.eval_accuracy]
    ...
    def print_to_excel(fname):
        ...
        # df5 = pd.DataFrame(Statistics.fedResults)
        # df5.columns = ['Train accuracy']  # , 'Test accuracy', 'Eval accuracy']
        df5 = pd.DataFrame({
            'Train accuracy': [Statistics.train_accuracy],
            'Test accuracy': [Statistics.test_accuracy],
            'Eval accuracy': [Statistics.eval_accuracy]})
        ...
        df5.to_excel(writer, sheet_name='FederatedLearning')
